...
TESLA_GRAPH_PROPERTIES = 0x71      # B->F: count(2B) + per property id/unit/category/line_mode (each len(2B)+UTF-8) + zero_based(1B); line_mode = "step"|"linear" graph render hint, zero_based = pin the y-axis bottom to 0
